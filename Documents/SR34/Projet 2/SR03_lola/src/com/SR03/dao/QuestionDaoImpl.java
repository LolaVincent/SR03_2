...
public class QuestionDaoImpl implements QuestionDao {
    ...
    private static final String SQL_QUESTIONNAIRE = "SELECT * FROM Question WHERE questionnaire_id =?";
    private static final String SQL_SELECT_PAR_ID = "SELECT * FROM Question WHERE id = ?";
    private static final String SQL_SELECT_PAR_QUESTION = "SELECT * FROM Question WHERE question = ?";
    private static final String SQL_INSERT        = "INSERT INTO Question(questionnaire_id, question, statut) VALUES (?, ?, 'A')";
    private static final String SQL_DELETE_PAR_ID = "DELETE FROM Question WHERE id = ?";
    private static final String SQL_UPDATE = "UPDATE Question SET question=? where id=?";
    ...
    public void creer( Question question ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_INSERT, true,
                    question.getQuestionnaire().getId(), question.getQuestion() 
			);
