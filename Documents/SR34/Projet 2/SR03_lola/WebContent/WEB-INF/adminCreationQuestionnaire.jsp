...
<body>
	<form  method="post" action="CreationQuestionnaire">
		...
		<input type="text" name="question1" id="question1"></input>
			...
			<input type="text" name="reponse11" id="reponse11"></input>
			<label for="reponse12"><br> &nbsp; Réponse 2 :</label>
			<input type="text" name="reponse12" id="reponse12"></input>
			<label for="reponse13"><br> &nbsp; Réponse 3 :</label>
			<input type="text" name="reponse13" id="reponse13"></input>
			<label for="reponse14"><br> &nbsp; Réponse 4 :</label>
			<input type="text" name="reponse14" id="reponse14"></input>
		...
		<input type="text" name="question2" id="question2"></input>
			<label for="reponse21"><br> &nbsp; Réponse 1 :</label>
			<input type="text" name="reponse21" id="reponse21"></input>
			<label for="reponse22"><br> &nbsp; Réponse 2 :</label>
			<input type="text" name="reponse22" id="reponse22"></input>
			<label for="reponse23"><br> &nbsp; Réponse 3 :</label>
			<input type="text" name="reponse23" id="reponse23"></input>
			<label for="reponse24"><br> &nbsp; Réponse 4 :</label>
			<input type="text" name="reponse24" id="reponse24"></input>
		...
		<input type="text" name="question3" id="question3"></input>
			<label for="reponse31"><br> &nbsp; Réponse 1 :</label>
			<input type="text" name="reponse31" id="reponse31"></input>
			<label for="reponse32"><br> &nbsp; Réponse 2 :</label>
			<input type="text" name="reponse32" id="reponse32"></input>
			<label for="reponse33"><br> &nbsp; Réponse 3 :</label>
			<input type="text" name="reponse33" id="reponse33"></input>
			<label for="reponse34"><br> &nbsp; Réponse 4 :</label>
			<input type="text" name="reponse34" id="reponse34"></input>
		...
		<input type="text" name="question4" id="question4"></input>
			<label for="reponse41"><br> &nbsp; Réponse 1 :</label>
			<input type="text" name="reponse41" id="reponse41"></input>
			<label for="reponse42"><br> &nbsp; Réponse 2 :</label>
			<input type="text" name="reponse42" id="reponse42"></input>
			<label for="reponse43"><br> &nbsp; Réponse 3 :</label>
			<input type="text" name="reponse43" id="reponse43"></input>
			<label for="reponse44"><br> &nbsp; Réponse 4 :</label>
			<input type="text" name="reponse44" id="reponse44"></input>
