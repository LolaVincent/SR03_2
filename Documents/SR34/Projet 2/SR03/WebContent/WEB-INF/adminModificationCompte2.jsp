...
<body>
	<form  method="post" action="ModificationCompte2">
		...
		<input type="text" name="mail" id="mail" value="${user.adresse}"></input>
		<label for="mot_passe"><br>Mot de passe : </label>
		<input type="text" name="mot_passe" id="mot_passe" value="${user.mdp}"></input>
		<label for="nom"><br>Nom :</label>
		<input type="text" name="nom" id="nom" value="${user.nom}"></input>
		<label for="societe"><br>Société :</label>
		<input type="text" name="societe" id="societe" value="${user.societe}"></input>
		<label for="telephone"><br>Téléphone :</label>
		<input type="text" name="telephone" id="telephone" value="${user.telephone}"></input>
