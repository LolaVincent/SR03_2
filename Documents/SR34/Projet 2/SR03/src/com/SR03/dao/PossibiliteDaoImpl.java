...
public class PossibiliteDaoImpl implements PossibiliteDao {
    ...
    private static final String SQL_SELECT        = "SELECT * FROM Possibilite ORDER BY ordre ASC";
    private static final String SQL_QUESTION = "SELECT * FROM Possibilite WHERE question_id =? ORDER BY ordre ASC";
    private static final String SQL_SELECT_PAR_ID = "SELECT * FROM Possibilite WHERE id = ? ORDER BY ordre ASC";
    private static final String SQL_INSERT        = "INSERT INTO Possibilite(question_id, possibilite, bonneReponse, statut,ordre) VALUES (?, ?, ?, 'A',?)";
    private static final String SQL_DELETE_PAR_ID = "DELETE FROM Possibilite WHERE id = ?";
    private static final String SQL_UPDATE = "UPDATE Possibilite SET possibilite=?, bonneReponse=?, ordre=? where id=?";
    ...
    public void creer( Possibilite possibilite ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_INSERT, true,
                    ...
                    possibilite.getBonneReponse(), possibilite.getOrdre());
    ...
    public void modifier( Possibilite possibilite ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_UPDATE, true,
            		...
            		possibilite.getOrdre(), possibilite.getId());
            int statut = preparedStatement.executeUpdate();
            if ( statut == 0 ) {
