...
public class CalculetteServiceLocator extends org.apache.axis.client.Service implements webservice.CalculetteService {
    ...
    private java.lang.String Calculette_address = "http://localhost:8080/webservice/services/Calculette";
    ...
    public webservice.Calculette getCalculette(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.CalculetteSoapBindingStub _stub = new webservice.CalculetteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.Calculette.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.CalculetteSoapBindingStub _stub = new webservice.CalculetteSoapBindingStub(new java.net.URL(Calculette_address), this);
                _stub.setPortName(getCalculetteWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice", "CalculetteService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice", "Calculette"));
        }
